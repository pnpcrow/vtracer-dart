...
abstract class AppLocalizations {
  ...
  /// No description provided for @saveSvg.
  ///
  /// In en, this message translates to:
  /// **'Save SVG'**
  String get saveSvg;
  ...
  /// No description provided for @infoInput.
  ///
  /// In en, this message translates to:
  /// **'Input'**
  String get infoInput;

  /// No description provided for @infoOutput.
  ///
  /// In en, this message translates to:
  /// **'Output'**
  String get infoOutput;

  /// No description provided for @infoPending.
  ///
  /// In en, this message translates to:
  /// **'pending…'**
  String get infoPending;

  /// No description provided for @infoShapes.
  ///
  /// In en, this message translates to:
  /// **'{count} shapes'**
  String infoShapes(int count);

  /// No description provided for @infoLayers.
  ///
  /// In en, this message translates to:
  /// **'{count} layers'**
  ...
  /// No description provided for @progressLoadingImage.
  ///
  /// In en, this message translates to:
  /// **'Loading image…'**
  String get progressLoadingImage;
  ...
  /// No description provided for @snackbarSavedToDownloads.
  ///
  /// In en, this message translates to:
